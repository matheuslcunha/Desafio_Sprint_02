    ...
    return MaterialApp(
      home: Scaffold(
          ...
          appBar: AppBar(
            ...
            elevation: 0,
            backgroundColor: Colors.white,
            leading: Image.asset('assets/images/hamburger-home-screen.png'),
            title: Text(
              'Welcome, Matheus',
              style: TextStyle(
                  color: Color(0xFF27214D),
          ...
          body: Container(
            child: ElevatedButton.icon(
              icon: Image.asset('assets/images/basket-home-screen.png'),
              label: Text(""),
...
//Text('Welcome, $authenticationScreen.nameController.text'),
